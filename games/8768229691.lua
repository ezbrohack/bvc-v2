...
local skywars, remotes = nil, {}
local store = {
	blocks = {},
	hand = {Type = nil, Name = nil, Ranged = nil, Rewrite = nil, Melee = nil, Pickaxe = nil},
	inventory = {},
	tools = {},
	noShoot = tick()
}
                        ...
                        if wool then
                            ...
                            for i = Expand.Value, 1, -1 do
                                ...
                                if not block then
                                    ...
                                    if blockpos then
                                        block = skywars.ItemMeta[wool.Rewrite.Type:gsub('{TeamId}', skywars.TeamController:getPlayerTeamId(lplr) or 'White')]
